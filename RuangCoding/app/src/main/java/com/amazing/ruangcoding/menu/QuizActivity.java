...
import com.amazing.ruangcoding.kuis.Question;
import com.amazing.ruangcoding.kuis.ResultQuizActivity;
    ...
    private void updateQuestion() {
        if (mQuestionNumber < mQuestionLibrary.getLength()) {
            ...
            if (mQuestionNumber == 14) {
                int res2 = getResources().getIdentifier("gbrkuis3", "drawable", getPackageName());
